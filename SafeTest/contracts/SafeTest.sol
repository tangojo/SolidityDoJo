...
/**
   ...
   - _maxTxAmount = 500 * 10**6 * 10**9; // initially set half a billion
   - numTokensSellToAddToLiquidity = 500 * 10**6 * 10**9; // initially set half a billion
‚
   Changes:
...
contract SafeTest is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        // change for testnet pancakeswap router address 
